                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16 dark:bg-gray-900">
                                ...
                                <p className="text-xl font-bold text-gray-600 dark:text-gray-400">Confirma la eliminación del proyecto {''}
                                    <span className="text-purple-600">colocando tu password</span>
                                </p>
